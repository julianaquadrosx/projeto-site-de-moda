...
//     document.querySelector('.smallGrid a').classList.remove('active');
...
if(document.readyState == "complete") {
	...
	document.querySelectorAll(".largeGrid").addEventListener("click", function() {											
    document.querySelector(this).querySelector('a').classList.add('active');
    document.querySelector('.smallGrid a').classList.remove('active');
	var products = document.querySelectorAll('.product');
	for(product of products) {
		product.classList.add('large');
		setTimeout(function(){
			document.querySelector('.info-large').classList.add('show');
		}, 200);
		setTimeout(function(){

			document.querySelector('.view_gallery').dispatchEvent("click");	
		}, 400);								
	}
		return false;				
	});
	
	document.querySelector(".smallGrid").addEventListener("click", function(){		        
    document.querySelector(this).querySelector('a').classList.add('active');
    document.querySelector('.largeGrid a').classList.remove('active');
    
		document.querySelector('div.product').classList.remove('large');
		document.querySelector(".make3D").classList.remove('animate');	
    	document.querySelector('.info-large').classList.add("hide");
		setTimeout(function(){								
				document.querySelector('div.flip-back').dispatchEvent("click");
		}, 400);
		return false;
	});		
	
	document.querySelector(".smallGrid").addEventListener("click", function(){
		document.querySelector('.product').classList.remove('large');			
		return false;
	});
  
  document.querySelector('.colors-large a').addEventListener("click", function(){return false;});
	
	var products = document.querySelectorAll('.product')
	for(el of products) {	
		// Lift card and show stats on Mouseover
		document.querySelector(el).querySelector('.make3D').addEventListener('mouseover', function(){
				...
				document.querySelector(this).classList.remove('animate');			
				document.querySelector(this).parent().css('z-index', "1");
				document.querySelector(this).querySelector('div.carouselNext, div.carouselPrev').classList.remove('visible');
		});	
		
		// // Flip card to the back side
		// document.querySelector(el).querySelector('.view_gallery').addEventListener("click", function(){	
			
		// 	document.querySelector(el).querySelector('div.carouselNext, div.carouselPrev').classList.remove('visible');
		// 	document.querySelector(el).querySelector('.make3D').classList.add('flip-10');			
		// 	setTimeout(function(){					
		// 	document.querySelector(el).querySelector('.make3D').classList.remove('flip-10').classList.add('flip90').querySelector('div.shadow').show().fadeTo( 80 , 1, function(){
		// 			document.querySelector(el).querySelector('.product-front, .product-front div.shadow').hide();															
		// 		});
		// 	}, 50);
			
		// 	setTimeout(function(){
		// 		document.querySelector(el).querySelector('.make3D').classList.remove('flip90').classList.add('flip190');
		// 		document.querySelector(el).querySelector('.product-back').show().querySelector('div.shadow').show().fadeTo( 90 , 0);
		// 		setTimeout(function(){				
		// 			document.querySelector(el).querySelector('.make3D').classList.remove('flip190').classList.add('flip180').querySelector('div.shadow').hide();						
		// 			setTimeout(function(){
		...
		// 	document.querySelector(el).querySelector('.make3D').classList.remove('flip180').classList.add('flip190');
		// 	setTimeout(function(){
		// 		document.querySelector(el).querySelector('.make3D').classList.remove('flip190').classList.add('flip90');
		...
		// 	setTimeout(function(){
		// 		document.querySelector(el).querySelector('.make3D').classList.remove('flip90').classList.add('flip-10');
		...
		// 			document.querySelector(el).querySelector('.make3D').classList.remove('flip-10').css('transition', '100ms ease-out');		
		// 			document.querySelector(el).querySelector('.cx, .cy').classList.remove('s1 s2 s3');			
		// 		}, 100);			
		// 	}, 150);			
	...
	document.querySelector('.add-cart-large').each(function(i, el){
		document.querySelector(el).click(function(){
			...
			document.querySelector("#cart .cart-item").last()
 		    ...
 		    setTimeout(function(){
				document.querySelector("#cart .cart-item").last().classList.remove("flash");
			}, 10 );
